...
<body>
    ...
    ?>
    <!-- Titre de la page -->
    <h1 class="titre_principal">Gerez votre cyber café</h1>
    ...
    <div class="poste_container">
        ...
        include('config.php');
        $reponse = $bdd->query('SELECT utilisateur.nom AS nom_utilisateur, utilisateur.prenom, poste.nom, poste.type, poste.id AS id_poste, reservation.id, reservation.id_poste, reservation.id_utilisateur, reservation.date, reservation.heure_debut, reservation.heure_fin FROM poste,utilisateur,reservation WHERE reservation.id_utilisateur = utilisateur.id AND reservation.id_poste = poste.id');
