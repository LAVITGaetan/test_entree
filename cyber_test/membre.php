    ...
    <table class="tableau">
        ...
        <tbody>
            ...
            while ($donnees = $reponse->fetch()) {
                ...
                <td class="tableau_contenu"><input type="submit" class="tableau_entree" value="Modifier" name="modifier"></td>
                <td class="tableau_contenu"><input type="submit" class="tableau_entree" value="Supprimer" name="supprimer"></td>
                </tr>
                </form>';
            }
            ?>
